...
//         {
//             string number2 = "111";
//             System.Console.WriteLine(Method10(number2, out double number10, out bool result));
//         }
//         static double Method10(string number2, out double number10, out bool result)
//         {
//             number10 = 0;
//             result = true;
//             for (int i = 0; i < number2.Length; i++)
//             {
//                 if (Convert.ToInt32(number2[i]) != 1 || Convert.ToInt32(number2[i]) != 0)
//                 {
//                     result = false;
//                     break;
//                 }
//                 else if (Convert.ToInt32(number2[i]) == 1)
//                 {
//                     result = true;
...
for (int i = 0; i < number2.Length; i++)
{
    Convert.ToInt32(number2[i]);
    if (number2[i] != 1 || number2[i] != 0)
    {
        result = false;
    }
    else if (number2[i] == 1)
